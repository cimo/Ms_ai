...
export const NAME = Ce.checkVariable("MS_AI_NAME") || (process.env["MS_AI_NAME"] as string);
export const LABEL = Ce.checkVariable("MS_AI_LABEL") || (process.env["MS_AI_LABEL"] as string);
export const IS_DEBUG = Ce.checkVariable("MS_AI_IS_DEBUG") || (process.env["MS_AI_IS_DEBUG"] as string);
export const NODE_ENV = Ce.checkVariable("MS_AI_NODE_ENV") || (process.env["MS_AI_NODE_ENV"] as string);
export const URL_ROOT = Ce.checkVariable("MS_AI_URL_ROOT") || (process.env["MS_AI_URL_ROOT"] as string);
export const URL_CORS_ORIGIN = Ce.checkVariable("MS_AI_URL_CORS_ORIGIN") || (process.env["MS_AI_URL_CORS_ORIGIN"] as string);
