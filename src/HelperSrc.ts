...
export const NAME = Ce.checkVariable("MS_AI_NAME") || (process.env["MS_A_NAME"] as string);
export const LABEL = Ce.checkVariable("MS_AI_LABEL") || (process.env["MS_A_LABEL"] as string);
export const IS_DEBUG = Ce.checkVariable("MS_AI_IS_DEBUG") || (process.env["MS_A_IS_DEBUG"] as string);
...
export const URL_ENDPOINT = Ce.checkVariable("MS_AI_URL_ENDPOINT") || (process.env["MS_AI_URL_ENDPOINT"] as string);
...
export const REQUEST_IS_ENCODED = false;
